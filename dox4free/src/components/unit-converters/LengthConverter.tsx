        ...
        <div className="mt-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-gray-900 bg-opacity-40 p-4 rounded-lg border border-gray-800 hover:border-purple-900/30 transition-all duration-300">
              <p className="py-1">1 meter = <span className="text-purple-300 font-medium">3.28084 feet</span></p>
              <p className="py-1">1 inch = <span className="text-purple-300 font-medium">2.54 centimeters</span></p>
              <p className="py-1">1 kilometer = <span className="text-purple-300 font-medium">0.621371 miles</span></p>
            </div>
            <div className="bg-gray-900 bg-opacity-40 p-4 rounded-lg border border-gray-800 hover:border-purple-900/30 transition-all duration-300">
              <p className="py-1">1 foot = <span className="text-purple-300 font-medium">0.3048 meters</span></p>
              <p className="py-1">1 mile = <span className="text-purple-300 font-medium">1.60934 kilometers</span></p>
              <p className="py-1">1 yard = <span className="text-purple-300 font-medium">0.9144 meters</span></p>
            </div>
          </div>
        </div>
      </div>
