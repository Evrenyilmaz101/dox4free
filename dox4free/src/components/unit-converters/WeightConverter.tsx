...
const WeightConverter: React.FC = () => {
  ...
  const units: Unit[] = [
    ...
    { name: 'metric ton', conversion: 1000000 },
    { name: 'ounce', conversion: 28.3495 },
    { name: 'pound', conversion: 453.592 },
    { name: 'stone', conversion: 6350.29 },
    { name: 'us ton', conversion: 907185 },
    { name: 'imperial ton', conversion: 1016000 },
  ];
        ...
        <div className="mt-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="bg-gray-900 bg-opacity-40 p-4 rounded-lg border border-gray-800 hover:border-purple-900/30 transition-all duration-300">
              ...
              <p className="py-1">1 metric ton = <span className="text-purple-300 font-medium">1000 kilograms</span></p>
              <p className="py-1">1 pound = <span className="text-purple-300 font-medium">453.592 grams</span></p>
            </div>
          </div>
        </div>
      </div>
