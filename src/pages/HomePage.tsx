    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 my-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Feature 1 */}
          <div className="bg-gray-900 bg-opacity-95 rounded-lg p-6 border border-gray-800">
            <div className="w-12 h-12 bg-purple-800 rounded-full flex items-center justify-center mb-4">
