...
const AreaConverter: React.FC = () => {
  ...
  const units: Unit[] = [
    ...
    { name: 'square foot', conversion: 0.092903 },
    { name: 'square yard', conversion: 0.836127 },
      ...
      <div className="relative z-10">
        ...
        <div className={`mt-8 p-6 bg-gray-900 bg-opacity-70 rounded-lg border border-gray-800 transition-all duration-300 relative overflow-hidden ${isConverting ? 'opacity-70' : 'opacity-100'}`}>
          ...
          <div className="mt-4 text-sm text-purple-200">
            Convert between various area units including metric and imperial measurements
          </div>
        </div>
        
        {/* Common Conversions Reference */}
        <div className="mt-8 p-4 bg-gray-900 bg-opacity-50 rounded-lg border border-gray-800">
          <h3 className="text-lg font-medium text-purple-200 mb-3">Common Area Conversions</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm text-gray-300">
            <div>• 1 acre = 4,047 square meters</div>
            <div>• 1 hectare = 10,000 square meters</div>
            <div>• 1 square foot = 144 square inches</div>
