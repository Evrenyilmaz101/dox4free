...
const AreaConverter: React.FC = () => {
  ...
  const [toUnit, setToUnit] = useState<string>('square_foot');
  ...
  const units: Unit[] = [
    ...
    { 
      name: 'square_foot', 
      toSquareMeters: (value) => value * 0.09290304,
      fromSquareMeters: (value) => value / 0.09290304,
      symbol: 'ft²'
    },
    { 
      name: 'square_inch', 
    ...
    { 
      name: 'square_yard', 
      toSquareMeters: (value) => value * 0.83612736,
      fromSquareMeters: (value) => value / 0.83612736,
      symbol: 'yd²'
    },
    { 
      name: 'square_mile', 
    ...
    { 
      name: 'acre', 
      toSquareMeters: (value) => value * 4046.8564224,
      fromSquareMeters: (value) => value / 4046.8564224,
      symbol: 'ac'
    },
    { 
      name: 'hectare', 
  ...
  const convert = () => {
    ...
    setTimeout(() => {
      ...
      const squareMeters = fromUnitData.toSquareMeters(Number(inputValue));
      const convertedValue = toUnitData.fromSquareMeters(squareMeters);
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
            ...
            <div className="text-left md:text-right mt-4 md:mt-0">
              ...
              <div className="mt-1 text-indigo-200">
                {fromUnit !== toUnit && (
                  <>
                    {fromUnit === 'square_meter' && toUnit === 'square_foot' && '1 m² = 10.764 ft²'}
                    {fromUnit === 'square_foot' && toUnit === 'square_meter' && '1 ft² = 0.0929 m²'}
                    {fromUnit === 'square_meter' && toUnit === 'square_kilometer' && '1 km² = 1,000,000 m²'}
                    {fromUnit === 'square_kilometer' && toUnit === 'square_meter' && '1 km² = 1,000,000 m²'}
                    {fromUnit === 'acre' && toUnit === 'square_meter' && '1 acre = 4,046.86 m²'}
                    {fromUnit === 'square_meter' && toUnit === 'acre' && '1 acre = 4,046.86 m²'}
                    {fromUnit === 'hectare' && toUnit === 'acre' && '1 hectare = 2.47105 acres'}
                    {fromUnit === 'acre' && toUnit === 'hectare' && '1 hectare = 2.47105 acres'}
                    {fromUnit === 'square_mile' && toUnit === 'square_kilometer' && '1 mi² = 2.59 km²'}
                    {fromUnit === 'square_kilometer' && toUnit === 'square_mile' && '1 km² = 0.386 mi²'}
                  </>
                )}
              </div>
            </div>
        ...
        <div className="mt-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-gray-900 bg-opacity-40 p-4 rounded-lg border border-gray-800 hover:border-purple-900/30 transition-all duration-300">
              ...
              <p className="py-1">1 hectare = <span className="text-purple-300 font-medium">2.471 acres</span></p>
            ...
            <div className="bg-gray-900 bg-opacity-40 p-4 rounded-lg border border-gray-800 hover:border-purple-900/30 transition-all duration-300">
              ...
              <p className="py-1">1 square foot = <span className="text-purple-300 font-medium">144 square inches</span></p>
              <p className="py-1">1 square yard = <span className="text-purple-300 font-medium">9 square feet</span></p>
